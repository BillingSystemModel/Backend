...
public class TarifficationServiceTest {
    ...
    void testTarifficateShouldReturnSuccessfulResponse() throws IOException {
        ...
        CDR testCDR1 = new CDR(callTypeCode2, phoneNumber1, startDateTime1, endDateTime1);
        CDR testCDR2 = new CDR(callTypeCode2, phoneNumber1, startDateTime2, endDateTime2);
        ...
        CDRPlus testCDRPlus = new CDRPlus(callTypeCode2,phoneNumber1,startDateTime1,endDateTime1,Duration.between(startDateTime1, endDateTime1), tariffCode);
        ...
        CallDataDTO cd1 = new CallDataDTO(callTypeCode1,
                ...
                cost);
        CallDataDTO cd2 = new CallDataDTO(callTypeCode1,
                startDateTime2,
                endDateTime2,
                Duration.between(startDateTime2, endDateTime2),
                cost);
        CallDataDTO cd3 = new CallDataDTO(callTypeCode2,
                startDateTime1,
                endDateTime1,
                Duration.between(startDateTime1, endDateTime1),
                cost);
        ...
        TarifficationReportDTO testReport1 = new TarifficationReportDTO(phoneNumber1, tariffCode, calldata1, totalMinutes, totalCost);
        TarifficationReportDTO testReport2 = new TarifficationReportDTO(phoneNumber2, tariffCode, calldata2, totalMinutes, totalCost);
        ...
        testPhoneNumber1.setBalance(BigDecimal.valueOf(Double.parseDouble("300")));
        testPhoneNumber1.setPhoneNumber(phoneNumber1);
        testPhoneNumber2.setBalance(BigDecimal.valueOf(Double.parseDouble("300")));
        ...
        when(phoneNumberServiceMock.findByPhoneNumber(any(String.class))).thenReturn(testPhoneNumber1)
                                                                         .thenReturn(testPhoneNumber2);
        when(phoneNumberServiceMock.save(any(PhoneNumber.class))).thenReturn(testPhoneNumber1)
                                                                 .thenReturn(testPhoneNumber2);
    ...
    void testTarifficateShouldReturnAnotherResponse() throws IOException {
        ...
        testCDRList.add(testCDR1);
        testCDRList.add(testCDR2);
        ServiceResponse testResponse = new ServiceResponse(ResponseStatus.CONSUMER_ERROR, "OK");
